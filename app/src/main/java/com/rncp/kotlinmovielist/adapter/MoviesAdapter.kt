package com.rncp.kotlinmovielist.adapter
...
import com.rncp.kotlinmovielist.model.Movie
...
class MoviesViewHolder(itemView : View): RecyclerView.ViewHolder(itemView){
    ...
    fun bind(movie: Movie) {
        ...
        //Glide.with(itemView.context).load("https://image.tmdb.org/t/p/w500/9Rj8l6gElLpRL7Kj17iZhrT5Zuw.jpg").into(photo)
